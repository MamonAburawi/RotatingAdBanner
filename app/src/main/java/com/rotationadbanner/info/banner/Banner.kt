...
import com.rotationadbanner.info.R
import com.rotationadbanner.info.banner.Banner.OnAdListener
import java.util.*

// https://github.com/uncn/banner
...
//    private var mOnAdFailedToLoad: OnAdFailedToLoad<T>? = null
    ...
    interface OnAdListener<T> {
        fun onAdClicked(position: Int, item: T)
    }
    ...
    interface OnItemBindListener<T> {
        fun onAdBind(position: Int, item: T, view: ImageView)
    }

    interface OnAdFailedToLoad<T>{
        fun adFailedToLoad(error: String)
    }
    ...
    private inner class BannerAdapter : RecyclerView.Adapter<BannerViewHolder>() {
        ...
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BannerViewHolder {
            ...
            imageView.setOnClickListener {
                ...
                if (mOnItemClickListener != null)
                    mOnItemClickListener!!.onAdClicked(mCurrentIndex % mData.size, mData[mCurrentIndex % mData.size])
            }
        ...
        override fun onBindViewHolder(holder: BannerViewHolder, position: Int) {
            if (mOnItemBindListener != null)
                mOnItemBindListener!!.onAdBind(position % mData.size, mData[position % mData.size], holder.mImageView)
        }
    ...
    private class BannerViewHolder (itemView: View) : RecyclerView.ViewHolder(itemView) {
         var mImageView: ImageView = itemView.findViewById(R.id.banner_image_view_id)
    }

     fun setAdToImage(context: Context, ad: Ad, image: ImageView){
        val uri = ad.url.toUri()
...
//    fun onAdFailedToLoad(listener: OnAdFailedToLoad<T>){
//
//    }
